...
public partial class FrmDetalleFactura : Form
{
    ...
    {
        lblNumeroFactura.Text = $"Factura #{_factura.CodigoFactura:00000000}";
    ...
    private void CargarTotales()
    {
        ...
        var importeNeto = subtotal - descuento;
        var impuestos = Math.Round(importeNeto * _factura.PorcentajeImpuestos / 100m, 2,
            MidpointRounding.AwayFromZero);
        var total = importeNeto + impuestos;
        ...
        lblImpuestosValor.Text = impuestos.ToString("C2", CultureInfo.CurrentCulture);
